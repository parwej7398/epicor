...
const Industry = () => {
  return (
    <>
      <div id="Industry" className="lg:pt-14">
        <div>
          <p className="lg:text-5xl text-2xl text-center font-semibold">
            Specialist Industries
          </p>
        </div>
        <div
          className="lg:grid lg:grid-cols-3 lg:gap-10 lg:px-32 flex flex-col gap-5
         p-10 *:p-5 *:rounded-xl *:shadow-md *:shadow-teal-700 *:text-xl *:font-semibold *:cursor-pointer"
        >
          <div className="flex items-center border hover:bg-[#a9ded0ff]">
            <div>
              <img src={aerospace} alt="" className="size-10" />
            </div>
            <div>
          ...
          <div className="flex items-center border hover:bg-[#a9ded0ff]">
            <div>
              <img src={Automotive} alt="" className="size-10" />
            </div>
            <div>
              <p>Automotive</p>
            </div>
          ...
          <div className="flex items-center border hover:bg-[#a9ded0ff]">
            <div>
              <img src={Construction} alt="" className="size-10" />
            </div>
            <div>
          ...
          <div className="flex items-center border hover:bg-[#a9ded0ff]">
            <div>
              <img src={Electronics} alt="" className="size-10" />
            </div>
            <div>
          ...
          <div className="flex items-center border hover:bg-[#a9ded0ff]">
            <div>
              <img src={Fabricated} alt="" className="size-10" />
            </div>
            <div>
          ...
          <div className="flex items-center border hover:bg-[#a9ded0ff]">
            <div>
              <img src={Furniture} alt="" className="size-10" />
            </div>
            <div>
          ...
          <div className="flex items-center border hover:bg-[#a9ded0ff]">
            <div>
              <img src={Industrial} alt="" className="size-10" />
            </div>
            <div>
          ...
          <div className="flex items-center border hover:bg-[#a9ded0ff]">
            <div>
              <img src={Medical} alt="" className="size-10" />
            </div>
            <div>
              <p>Medical Device</p>
            </div>
          ...
          <div className="flex items-center border hover:bg-[#a9ded0ff]">
            <div>
              <img src={Metal} alt="" className="size-10" />
            </div>
            <div>
              <p>Metal Service Centers</p>
            </div>
          </div>
          <div className="flex items-center border hover:bg-[#a9ded0ff]">
            <div>
              <img src={Rubber} alt="" className="size-10" />
            </div>
            <div>
