...
const Manufacturing = () => {
  ...
  return (
    <>
      <div className="lg:flex lg:pt-[7.4rem]">
        <div className="flex flex-col gap-6 lg:px-36 p-10 bg-[#042e3dff] text-white">
          <p>Manufacturing</p>
          <div>
            <button className="bg-[#47798fff] lg:p-1 rounded-md">
              Manufacturing
            </button>
          </div>
          ...
          <p className="lg:text-xl">
            The insights you need to drive growth, boost profits, and explore
            the potential of the connected shop floor.
          </p>
          <div className="lg:flex  gap-2">
            <p
              className="p-2 m-2 bg-[#e00700ff] rounded-md"
              onClick={() => handleClick("Contect")}
            >
              ASK OUR MANUFACTURING EXPERTS
            </p>
            <p className="p-2 m-2 bg-[#327e9cff] rounded-md">CHAT WITH SALES</p>
          </div>
        </div>
      ...
      <div className="flex lg:justify-center hide-scroll overflow-auto py-2 lg:top-[7.5rem] sticky px-[10%] gap-2 bg-white">
        ...
        <button
          className="p-2 px-4 hover:bg-slate-100 hover:rounded-md"
          onClick={() => handleClick("ManufactringModes")}
        >
          ManufactringModes
        </button>
        <button
        ...
        <button
          className="p-2 px-4 hover:bg-slate-100 hover:rounded-md"
          onClick={() => handleClick("FeatureProducts")}
        >
          FeatureProducts
        </button>
        <button
          className="p-2 px-4 hover:bg-slate-100 hover:rounded-md"
          onClick={() => handleClick("KineticResources")}
        >
          KineticResources
        </button>
        <button
